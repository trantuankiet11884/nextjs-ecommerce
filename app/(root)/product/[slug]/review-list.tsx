...
export default function ReviewList({
  ...
  return (
    <div className="space-y-2">
      {reviews.length === 0 && <div>Không có đánh giá</div>}
          ...
          <div className="space-y-3">
            ...
            {userId ? (
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                >
                  Viết đánh giá của khách hàng
                </Button>
                <DialogContent className="sm:max-w-[425px]">
                  <Form {...form}>
                    <form method="post" onSubmit={form.handleSubmit(onSubmit)}>
                      <DialogHeader>
                        <DialogTitle>Viết đánh giá của khách hàng</DialogTitle>
                        <DialogDescription>
                          Chia sẻ suy nghĩ của bạn với các khách hàng khác
                        </DialogDescription>
                      </DialogHeader>
              ...
              <CardHeader>
                <div className="flex-between">
                  ...
                  <div className="italic text-sm flex">
                    <Check className="h-4 w-4" /> Đã xác minh mua hàng
                  </div>
                </div>
